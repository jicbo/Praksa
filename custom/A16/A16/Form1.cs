...
namespace A16
{
    public partial class Form1 : Form
    {
        ...
        public void Konekcija()
        {
            ...
            konekcija.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\bojic\Documents\izlozbaPasa.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        private void prikaziBTN_Click(object sender, EventArgs e)
        {
            ...
            Konekcija();
            komanda.CommandText = @"SELECT K.id_kategorije AS ""Sifra"", k.naziv as ""Naziv kategorije"", COUNT(R.rezultat) as ""Broj pasa"" FROM KATEGORIJA k INNER join rezultat r on r.id_kategorije = k.id_kategorije WHERE R.id_izlozbe = @izlozbaId GROUP BY K.id_kategorije, k.naziv ORDER BY K.id_kategorije";
